<?php
/**
 * IC_GitHub_Updater - GitHub自動更新クラス
 *
...
class IC_GitHub_Updater {
    ...
    public function handle_check_update() {
        ...
        // キャッシュをクリア
        delete_transient( Intelligent_Checker::CACHE_KEY );
    ...
    private function get_github_release_info() {
        // キャッシュをチェック
        $cached = get_transient( Intelligent_Checker::CACHE_KEY );
        if ( $cached !== false ) {
            return $cached;
        }

        // GitHub APIリクエスト
        $response = wp_remote_get( Intelligent_Checker::GITHUB_API_URL, array(
            'timeout' => 10,
            'headers' => array(
        ...
        // キャッシュに保存
        set_transient( Intelligent_Checker::CACHE_KEY, $release_info, Intelligent_Checker::CACHE_EXPIRATION );
    ...
    public function check_for_plugin_update( $transient ) {
        ...
        // 現在のバージョンと比較
        $current_version = Intelligent_Checker::VERSION;
    ...
    public function plugin_info( $result, $action, $args ) {
        ...
        return (object) array(
            ...
            'author'            => '<a href="https://github.com/' . Intelligent_Checker::GITHUB_USERNAME . '">' . Intelligent_Checker::GITHUB_USERNAME . '</a>',
            'author_profile'    => 'https://github.com/' . Intelligent_Checker::GITHUB_USERNAME,
            'homepage'          => 'https://github.com/' . Intelligent_Checker::GITHUB_USERNAME . '/' . Intelligent_Checker::GITHUB_REPO,
